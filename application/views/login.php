...
<body id="admission_bg">
	...
	<div id="form_container" class="clearfix">
		<figure>
			<a href="index.html"><img src="<?php echo base_url();?>assets/menu1/img/logo.png" width="149" height="42" data-retina="true" alt=""></a>
		</figure>
		<div id="wizard_container">
			...
			<form name="example-1" id="wrapped" method="POST">
				...
				<div id="middle-wizard">
					<div class="step">
						<div id="intro">
							<figure><img src="<?php echo base_url();?>assets/menu1/img/wizard_intro_icon.svg" alt=""></figure>
