  ...
  <div class="container margin_30_95" style="padding-top: 75px;">
      ...
      <div class="row" id="universitas_show_home">
        ...
        <div class="col-lg-4 col-md-2" data-wow-offset="150" style="width: 50%;padding-right: 5px; padding-left: 5px;">
          ...
          <a href="#0" class="grid_item">
            ...
            <figure class="block-reveal" style="height: 100% !important;">
              ...
              <img src="http://admin.edumedia.id/assets/images/card_universitas/KEAMANAN_NASIONAL.png" class="img-fluid" alt="" style="animation: color 0.5s ease-in-out;animation-fill-mode: forwards;width: 100%;">
        ...
        <div class="col-lg-4 col-md-2" data-wow-offset="150" style="width: 50%;padding-right: 5px; padding-left: 5px;">
          ...
          <a href="#0" class="grid_item">
            ...
            <figure class="block-reveal" style="height: 100% !important;">
              ...
              <img src="http://admin.edumedia.id/assets/images/card_universitas/STRATEGI_PERTAHANAN.png" class="img-fluid" alt="" style="animation: color 0.5s ease-in-out;animation-fill-mode: forwards;width: 100%;">
        ...
        <div class="col-lg-4 col-md-2" data-wow-offset="150" style="width: 50%;padding-right: 5px; padding-left: 5px;">
          ...
          <a href="#0" class="grid_item">
            ...
            <figure class="block-reveal" style="height: 100% !important;">
              ...
              <img src="http://admin.edumedia.id/assets/images/card_universitas/MANAJEMEN_PERTAHANAN.png" class="img-fluid" alt="" style="animation: color 0.5s ease-in-out;animation-fill-mode: forwards;width: 100%;">
        ...
        <div class="col-lg-4 col-md-2" data-wow-offset="150" style="width: 50%;padding-right: 5px; padding-left: 5px;">
          ...
          <a href="<?php echo base_url();?>index.php/Prodi/get_prodi_by_id_fakultas" class="grid_item">

            <figure class="block-reveal" style="height: 100% !important;">

              <div class="block-horizzontal" style="animation: none;background: none;"></div>

              <img src="http://admin.edumedia.id/assets/images/card_universitas/TEKNOLOGI_PERTAHANAN.png" class="img-fluid" alt="" style="animation: color 0.5s ease-in-out;animation-fill-mode: forwards;width: 100%;">
