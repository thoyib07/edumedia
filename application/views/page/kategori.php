<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      var id_kategori = pathArray[4];

      $.ajax({

          url : "<?php echo site_url('index.php/Kategori/get_sub_kategori_by_id_kategori')?>/"+id_kategori,
          ...
          success: function(response){
              ...
              response.forEach(function(element) {
                  ...
                  // $('#kategori_show_home').append('<div class="col-lg-4 col-md-2" data-wow-offset="150" style="width: 50%;padding-right: 5px; padding-left: 5px;"><a href="<?php echo base_url();?>index.php/Materi/get_materi/'+element.id_kategori+'" class="grid_item"><figure class="block-reveal" style="height: 100% !important;"><div class="block-horizzontal" style="animation: none;background: none;"></div><img src="http://admin.edumedia.id/'+ element.background +'" class="img-fluid" alt="" style="animation: color 0.5s ease-in-out;animation-fill-mode: forwards;"><div class="info" style="padding: 0px 0px 3px 6px;animation: color 0.7s ease-in-out; animation-delay: 0.7s;-webkit-animation-delay: 0.7s;-moz-animation-delay: 0.7s;opacity: 0;animation-fill-mode: forwards;-webkit-animation-fill-mode: forwards;"><p style="color: #ffffff;">'+ element.nama_kategori +'</p></div></figure></a></div>');
