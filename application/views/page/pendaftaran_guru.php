		...
		function simpan_data(){
	        ...
	        if (kata_sandi && konfirmasi_kata_sandi) {
	        	if (kata_sandi != konfirmasi_kata_sandi) {
	        		...
	        		url = "<?php echo site_url('index.php/Pendaftaran_guru/ajax_save')?>";
		            misage_success = "Pendaftaran Berhasil";
			                    ...
			                    {   
			                        if (data.status == true) {
			                            ...
			                            function(){
			                                // reload_table();
			                                // location.reload();
			                                location.replace("<?php echo site_url('index.php/Registrasi_guru')?>");
		...
		<div id="wizard_container">
			...
			<form name="formulir_pendaftaran" id="formulir_pendaftaran" >
				...
				<div id="middle-wizard">
					<div class="step">
						<center><h4 class="main_question">Daftar Sebagai Guru</h4></center>
				...
				<div id="bottom-wizard">
					...
					<p class="text-center" onclick="simpan_data()"><i class="fa fa-google-plus"></i><a style="width: 100%;background: #4a71f1;" href="#0" class="btn_1 rounded">Submit</a></p>
