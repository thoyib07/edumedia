...
class Search extends CI_Controller {
...

	{
		...
		$data['content'] = $this->load->view('page/search','',true);
	...
	public function by_matapelajaran()

	{
		setLastPage();
        $matapelajaran_like = $this->input->post('matapelajaran');
		...
		$data_content['like_matapelajaran'] = $matapelajaran_like;

		$data['content'] = $this->load->view('page/search',$data_content,true);
