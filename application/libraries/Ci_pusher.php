...
// require_once("../third_party/pusher/pusher.php");
// require_once("/home/edumedia/public_html/lms.edumedia.id/application/third_party/pusher/pusher.php");
...
Class Ci_pusher
{
    ...
    private function options()
    {
        ...
        $options['useTLS']              = ($this->config->item('pusher_useTLS')) ?: NULL;
